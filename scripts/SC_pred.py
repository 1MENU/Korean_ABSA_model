...
dataset_train, dataset_dev, dataset_test = get_SC_dataset(test_data, test_data, test_data, args.pretrained)
...
submission_pred, yy = SC_inference_model(mymodel, InferenceLoader, lf, device)
